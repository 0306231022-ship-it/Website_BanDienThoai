...
const ServerErrorPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4 text-center">
      {/* 1. Phần hình ảnh minh họa (Dùng SVG inline để không cần cài thêm thư viện icon) */}
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center w-full max-w-sm">
        <button 
          ...
          className="px-6 py-3 rounded-lg bg-blue-600 text-white font-semibold hover:bg-blue-700 transition-colors shadow-lg hover:shadow-blue-200 flex items-center justify-center gap-2"
        >
