...
function ChinhSuaImgaeVaTen({DuLieu}) {
    ...
    <div className="w-full bg-white rounded-3xl p-6">
      <div className="flex flex-col items-center mb-10 pt-4">
        <div className="relative group">
          ...
          <img src={`http://localhost:3001/${DuLieu.LoGo}`} alt="Logo" className="relative w-28 h-28 rounded-full object-cover border-4 border-white shadow-xl" />
        </div>
      ...
      <div className="space-y-3">
        <button onClick={() => OpenMoDal({ DuLieu:DuLieu.TenWebsite},{TenTrang:'ChinhSuaTen',url: '/admin/ChinhSuaTen'
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-left">
              ...
              <span className="text-[15px] font-bold text-gray-700">{DuLieu.TenWebsite}</span>
            </div>
          </div>
        ...
        <button onClick={() => OpenMoDal({DuLieu: DuLieu.LoGo},{ TenTrang:'SuaAnhThuongHieu' , url:'/admin/ChinhLoGo'})}
