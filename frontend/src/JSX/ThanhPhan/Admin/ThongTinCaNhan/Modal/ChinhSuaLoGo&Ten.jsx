    ...
    <div className="w-full bg-white rounded-3xl p-6">
      <div className="flex flex-col items-center mb-10 pt-4">
        <div className="relative group">
          ...
          <img src={`http://localhost:3001/${modalState.DuLieu.avatar}`} alt="Logo" className="relative w-28 h-28 rounded-full object-cover border-4 border-white shadow-xl" />
        </div>
      </div>
      <div className="space-y-3">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="text-left">
              <span className="block text-xs font-bold text-gray-400 uppercase tracking-tight">ảnh đại diện</span>
