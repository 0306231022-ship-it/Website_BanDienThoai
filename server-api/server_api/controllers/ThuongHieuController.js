...
import ThuongHieuModel from '../models/ThuongHieu';
...
export default class ThuongHieuController{
    ...
    static async ThemThuongHieu(req,res){
         const { TenThuongHieu, MoTa } = req.body;
         ...
         const ThemTH= await ThuongHieuModel.ThemThuongHieu(TenThuongHieu, MoTa, pathFile);
            if(ThemTH===1){
                return res.json({
                    Status:true,
